<template>
  <transition name="sp-zoom-in-top" @after-leave="doDestroy">
    <div
      class="sp-color-dropdown"
      v-show="showPopper">
      <div class="sp-color-dropdown__main-wrapper">
        <hue-slider ref="hue" :color="color" vertical style="float: right;"></hue-slider>
        <sv-panel ref="sl" :color="color"></sv-panel>
      </div>
      <alpha-slider v-if="showAlpha" ref="alpha" :color="color"></alpha-slider>
      <predefine v-if="predefine" :color="color" :colors="predefine"></predefine>
      <div class="sp-color-dropdown__btns">
        <span class="sp-color-dropdown__value">
          <el-input
            v-model="customInput"
        ...
        <el-button
          size="mini"
          type="text"
          class="sp-color-dropdown__link-btn"
          @click="$emit('clear')">
