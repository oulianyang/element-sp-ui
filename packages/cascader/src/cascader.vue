    ...
    >
      <template slot="suffix">
        <i
          ...
          key="clear"
          class="sp-input__icon sp-icon-close-circle"
      ...
      >
        ...
        >
          ...
          <slot v-else name="empty">
            <li class="sp-cascader__empty-text">
...
import ElCascaderPanel from '@fe/element-sp-ui/packages/cascader-panel';
import AriaUtils from '@fe/element-sp-ui/src/utils/aria-utils';
import { t } from '@fe/element-sp-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from '@fe/element-sp-ui/src/utils/util';
import { isUndefined, isFunction } from '@fe/element-sp-ui/src/utils/types';
import { isDef } from '@fe/element-sp-ui/src/utils/shared';
import {
  addResizeListener,
  removeResizeListener
} from '@fe/element-sp-ui/src/utils/resize-event';
