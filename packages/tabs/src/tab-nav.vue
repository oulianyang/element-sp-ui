  ...
  export default {
    ...
    render(h) {
      ...
      const scrollBtn = scrollable
        ? [
          <span class={['sp-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="sp-icon-left"></i></span>,
          <span class={['sp-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="sp-icon-right"></i></span>
        ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <span class="sp-icon-close" on-click={(ev) => { onTabRemove(pane, ev); }}></span>
          : null;

        const dot = pane.dot
          ? <sup class='sp-tabs-nav--dot'></sup>
          : null;
      ...
      return (
        <div class={['sp-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${ this.rootTabs.tabPosition }`]}>
          {scrollBtn}
          <div class={['sp-tabs__nav-scroll']} ref="navScroll">
            <div
