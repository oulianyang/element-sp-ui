<template>
  <transition name="sp-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="sp-picker-panel sp-date-picker sp-popper"
      :class="[{
      ...
      <div class="sp-picker-panel__body-wrapper">
        ...
        <div class="sp-picker-panel__body">
          <div class="sp-date-picker__left">
            <div
              class="sp-date-picker__header"
              :class="{ 'sp-date-picker__header--bordered': currentView === 'year' || currentView === 'month' || currentView === 'quarter' }"
              ...
              <span class="sp-date-picker__header-center">
                <span
                  ...
                  role="button"
                  class="sp-date-picker__header-label">{{ yearLabel }}</span>
                <span
          ...
          <div class="sp-date-picker__right" v-if="showTime">
            <div class="sp-date-picker_time-input">
              <el-input ref="input" suffix-icon="sp-icon-time-circle" :clearable="false" :value="timeSpinnerValue"/>
            </div>
            <div class="sp-date-picker_time-panel">
              <TimeSpinner
                ref="spinner"
                :date="date"
            ...
            <!-- <div class="sp-date-picker__time-header" v-if="showTime">
              <span class="sp-date-picker__editor-wrap">
                <el-input
              ...
              <span class="sp-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
                <el-input
                  ref="input"
