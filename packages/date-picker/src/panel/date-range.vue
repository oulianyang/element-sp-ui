<template>
  <transition name="sp-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="sp-picker-panel sp-date-range-picker sp-popper"
      :class="[{
      ...
      <div class="sp-picker-panel__body-wrapper">
        ...
        <div class="sp-picker-panel__body">
          <div class="sp-date-range-picker__time-header" v-if="showTime">
            <span class="sp-date-range-picker__editors-wrap">
              <span class="sp-date-range-picker__time-picker-wrap">
                <el-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="sp-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="sp-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <el-input
                  size="small"
                  class="sp-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="sp-icon-right"></span>
            <span class="sp-date-range-picker__editors-wrap is-right">
              <span class="sp-date-range-picker__time-picker-wrap">
                <el-input
                  size="small"
                  class="sp-date-range-picker__editor"
              ...
              <span class="sp-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <el-input
                  size="small"
                  class="sp-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="sp-picker-panel__content sp-date-range-picker__content is-left">
            <div class="sp-date-range-picker__header">
              <div>
                <button
                  type="button"
                  @click="leftPrevYear"
                  class="sp-picker-panel__icon-btn sp-icon-doubleleft"></button>
                <button
                  type="button"
                  @click="leftPrevMonth"
                  class="sp-picker-panel__icon-btn sp-icon-left"></button>
              </div>
              <div class="sp-date-range-picker__label">{{ leftLabel }}</div>
              <div>
                <button
                  type="button"
                  @click="leftNextMonth"
                  ...
                  class="sp-picker-panel__icon-btn sp-icon-right"></button>
                <button
                  type="button"
                  @click="leftNextYear"
                  v-if="unlinkPanels"
                  ...
                  class="sp-picker-panel__icon-btn sp-icon-doubleright"></button>
              </div>
            </div>
            <div class="sp-date-range-picker__date-table">
              <date-table
          ...
          <div class="sp-picker-panel__content sp-date-range-picker__content is-right">
            <div class="sp-date-range-picker__header">
              <div>
                <button
                  type="button"
              ...
              <div class="sp-date-range-picker__label">{{ rightLabel }}</div>
              <div>
                <button
                  type="button"
      ...
      <div class="sp-picker-panel__footer" v-if="showTime">
        <el-button
          size="mini"
          type="text"
