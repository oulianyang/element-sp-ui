<template>
  <table @click="handleYearTableClick" class="sp-year-table">
    <tbody>
      <tr>
        <td class="available" :class="getCellStyle(startYear + 0)">
          <a class="cell">{{ startYear + 0 }}</a>
        </td>
...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear, parseQuarterFormatDate } from '../../../../src/utils/date-util';
