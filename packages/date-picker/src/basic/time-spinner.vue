<template>
  <div class="sp-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <el-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        class="sp-time-spinner__wrapper"
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="sp-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="sp-time-spinner__arrow sp-icon-up"></i>
        <i v-repeat-click="increase" class="sp-time-spinner__arrow sp-icon-down"></i>
        <ul class="sp-time-spinner__list" ref="hours">
          <li
            class="sp-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sp-time-spinner__arrow sp-icon-up"></i>
        <i v-repeat-click="increase" class="sp-time-spinner__arrow sp-icon-down"></i>
        <ul class="sp-time-spinner__list" ref="minutes">
          <li
            class="sp-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sp-time-spinner__arrow sp-icon-up"></i>
        <i v-repeat-click="increase" class="sp-time-spinner__arrow sp-icon-down"></i>
        <ul class="sp-time-spinner__list" ref="seconds">
          <li
