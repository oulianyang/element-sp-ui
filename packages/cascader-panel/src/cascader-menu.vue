...
export default {
  ...
  methods: {
    ...
    renderEmptyText(h) {
      return (
        <div class="sp-cascader-menu__empty-text">{ this.t('el.cascader.noData') }</div>
      );
    },
    renderNodeList(h) {
      const { menuId } = this;
      ...
      return [
        ...nodes,
        isHoverMenu ? <svg ref='hoverZone' class='sp-cascader-menu__hover-zone'></svg> : null
      ];
    }
  },
