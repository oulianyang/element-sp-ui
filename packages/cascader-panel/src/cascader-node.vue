<script>
  ...
  import ElRadio from '@fe/element-sp-ui/packages/radio';
  import { isEqual } from '@fe/element-sp-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="sp-icon-check sp-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="sp-icon-loading sp-cascader-node__loading-rotate sp-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="sp-icon-right sp-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="sp-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
