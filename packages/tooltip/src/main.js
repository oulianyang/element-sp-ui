...
import { addClass, removeClass, on, off } from '@fe/element-sp-ui/src/utils/dom';
...
export default {
  ...
  data() {
    return {
      tooltipId: `sp-tooltip-${generateId()}`,
      timeoutPending: null,
      focusing: false
    };
  },
      ...
      this.popperVM.node = (
        <transition
          ...
          <div
            ...
            class={
              ['sp-tooltip__popper', 'is-' + this.effect, this.popperClass]
            }>
