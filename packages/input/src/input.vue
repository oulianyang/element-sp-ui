<template>
  <div :class="[
    ...
    inputFixWidthType ? 'sp-input-fix-width--' + inputFixWidthType : '',
    {
      ...
      'sp-input--suffix': $slots.suffix || suffixIcon || clearable || showPassword
    }
    ]"
  ...
  >
    <template v-if="type !== 'textarea'">
      <!-- 前置元素 -->
      <div :class="['sp-input-group__prepend', { 'sp-input-group__sloteditable': prependEditable }]" v-if="$slots.prepend">
      ...
      >
      <!-- 前置内容 -->
      <span class="sp-input__prefix" v-if="$slots.prefix || prefixIcon">
        <slot name="prefix"></slot>
        <i class="sp-input__icon"
           v-if="prefixIcon"
           :class="prefixIcon">
        </i>
      </span>
      ...
      <span
        ...
        <span class="sp-input__suffix-inner">
          ...
          <i v-if="showClear"
            class="sp-input__icon sp-icon-close-circle sp-input__clear"
            @mousedown.prevent
            @click="clear"
          ></i>
          <i v-if="showPwdVisible"
            :class="['sp-input__icon', passwordVisible ? 'sp-icon-eye' : 'sp-icon-eye-close', 'sp-input__clear']"
            @click="handlePasswordVisible"
          ></i>
          <span v-if="isWordLimitVisible" class="sp-input__count">
            <span class="sp-input__count-inner">
      ...
      <!-- 后置元素 -->
      <div class="sp-input-group__append" v-if="$slots.append">
    ...
    <span v-if="isWordLimitVisible && type === 'textarea'" class="sp-input__count">{{ textLength }}/{{ upperLimit }}</span>
  </div>
</template>
<script>
  ...
  import merge from '@fe/element-sp-ui/src/utils/merge';
