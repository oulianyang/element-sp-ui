<script type="text/jsx">
  ...
  import Menubar from '@fe/element-sp-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from '@fe/element-sp-ui/src/utils/dom';
    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'sp-menu--horizontal': this.mode === 'horizontal',
            'sp-menu--collapse': this.collapse,
            "sp-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'sp-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'sp-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'sp-menu--collapse')) {
                  removeClass(el, 'sp-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'sp-menu--collapse');
                } else {
                  addClass(el, 'sp-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
