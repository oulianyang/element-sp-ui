<template>
  <div
    class="sp-slider"
    :class="{ 'is-vertical': vertical, 'sp-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="sp-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="sp-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="sp-slider__stop sp-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="sp-slider__marks">
          <slider-marker
...
<script type="text/babel">
  import ElInputNumber from '@fe/element-sp-ui/packages/input-number';
