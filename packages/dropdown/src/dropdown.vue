<script>
  ...
  import ElButtonGroup from '@fe/element-sp-ui/packages/button-group';
  ...
  export default {
    ...
    watch: {
      ...
      focusing(val) {
        const selfDefine = this.$el.querySelector('.sp-dropdown-selfdefine');
        if (selfDefine) { // 自定义
          if (val) {
    ...
    methods: {
      triggerElmRender() {
        ...
        if (splitButton) {
          triggerElm = <el-button-group>
            ...
            <el-button ref="trigger" type={type} size={dropdownSize} class="sp-dropdown__caret-button" disabled={disabled}>
              {
                this.$slots.icon || (
                  <i class="sp-dropdown__icon sp-icon-down"></i>
                )
              }
            </el-button>
          </el-button-group>;
      ...
      initAria() {
        ...
        if (!this.splitButton) { // 自定义
          ...
          this.triggerElm.setAttribute('class', (this.triggerElm.getAttribute('class') || '') + ' sp-dropdown-selfdefine'); // 控制
        }
      },
      initEvent() {
    ...
    render(h) {
      ...
      return (
        <div class={{
          'sp-dropdown': true,
          'sp-dropdown--unfold': this.visible
        }} v-clickoutside={hide} aria-disabled={disabled}>
          {this.triggerElmRender()}
          {menuElm}
        </div>
      );
    }
