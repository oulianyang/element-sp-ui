...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      id() {
        return `sp-autocomplete-${generateId()}`;
      }
    },
    watch: {
    ...
    methods: {
      ...
      highlight(index) {
        ...
        const suggestion = this.$refs.suggestions.$el.querySelector('.sp-autocomplete-suggestion__wrap');
        const suggestionList = suggestion.querySelectorAll('.sp-autocomplete-suggestion__list li');
