import Vue from 'vue';
import scrollbarWidth from '@fe/element-sp-ui/src/utils/scrollbar-width';
...
class TableLayout {
  constructor(options) {
    ...
    this.gutterWidth = scrollbarWidth('sp-customer--scroll-bar');
  ...
  updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      const body = bodyWrapper.querySelector('.sp-table__body');
  ...
  updateElsHeight() {
    ...
    const headerTrElm = headerWrapper ? headerWrapper.querySelector('.sp-table__header tr') : null;
