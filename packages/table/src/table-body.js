import { arrayFindIndex } from '@fe/element-sp-ui/src/utils/util';
import { getCell, getColumnByCell, getRowIdentity } from './util';
import { getStyle, hasClass, removeClass, addClass } from '@fe/element-sp-ui/src/utils/dom';
...
export default {
  ...
  watch: {
    ...
    'store.states.hoverRow'(newVal, oldVal) {
      ...
      raf(() => {
        const rows = this.$el.querySelectorAll('.sp-table__row');
  ...
  methods: {
    ...
    handleCellMouseEnter(event, row) {
      ...
      if (!(hasClass(cellChild, 'sp-tooltip') && cellChild.childNodes.length)) {
        return;
      }
      ...
      if (this.hasExpandColumn && isRowExpanded(row)) {
        ...
        return [[
          ...
          <tr key={'expanded-row__' + tr.key}>
            <td colspan={ this.columnsCount } class="sp-table__cell sp-table__expanded-cell">
