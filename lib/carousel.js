...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/carousel/src/main.vue?vue&type=template&id=3f0471ca&
var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c(
        "div",
        {
          staticClass: "sp-carousel__container",
            ...
            ? _c("transition", { attrs: { name: "carousel-arrow-left" } }, [
                _c(
                  "button",
                  {
                    ...
                    staticClass: "sp-carousel__arrow sp-carousel__arrow--left",
                    attrs: { type: "button" },
                    on: {
                      mouseenter: function($event) {
            ...
            ? _c("transition", { attrs: { name: "carousel-arrow-right" } }, [
                _c(
                  "button",
                  {
                    ...
                    staticClass: "sp-carousel__arrow sp-carousel__arrow--right",
                    attrs: { type: "button" },
                    on: {
                      mouseenter: function($event) {
              ...
              return _c(
                "li",
                {
                  ...
                  class: [
                    ...
                    "sp-carousel__indicator--" + _vm.direction,
                ...
                [
                  _c("button", { staticClass: "sp-carousel__button" }, [
                    _vm.hasLabel
...
// CONCATENATED MODULE: ./packages/carousel/src/main.vue?vue&type=template&id=3f0471ca&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    carouselClasses: function carouselClasses() {
      var classes = ['sp-carousel', 'sp-carousel--' + this.direction];
      if (this.type === 'card') {
        classes.push('sp-carousel--card');
      }
      return classes;
    },
    indicatorsClasses: function indicatorsClasses() {
      var classes = ['sp-carousel__indicators', 'sp-carousel__indicators--' + this.direction];
      if (this.hasLabel) {
        classes.push('sp-carousel__indicators--labels');
      }
      if (this.indicatorPosition === 'outside' || this.type === 'card') {
        classes.push('sp-carousel__indicators--outside');
      }
      return classes;
    }
  },
