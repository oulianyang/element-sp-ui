...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/steps/src/step.vue?vue&type=template&id=d8cc6738&
var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "sp-step__head", class: "is-" + _vm.currentStatus },
        [
          _c(
            "div",
            {
              staticClass: "sp-step__line",
              style: _vm.isLast
                ? ""
            ...
            [
              _c("i", {
                staticClass: "sp-step__line-inner",
                style: _vm.lineStyle
              })
            ]
          ),
            ...
            [
              _vm.currentStatus !== "success" && _vm.currentStatus !== "error"
                ? _vm._t("icon", [
                    _vm.icon
                      ? _c("i", {
                          staticClass: "sp-step__icon-inner",
                          class: [_vm.icon]
                        })
                      : _vm.index < _vm.$parent.active
                      ? _c("i", {
                          staticClass: "sp-step__icon-inner",
                          class: "sp-icon-check"
                        })
                      : !_vm.icon && !_vm.isSimple
                      ? _c("div", { staticClass: "sp-step__icon-inner" }, [
                          _vm._v(
                            "\n          " +
                              _vm._s(_vm.index + 1) +
                              "\n        "
                ...
                : _c("i", {
                    staticClass: "sp-step__icon-inner is-status",
                    class: [
                      "sp-icon-" +
          ...
          !_vm.isVertical || _vm.isSimple
            ? _c("div", { staticClass: "sp-step__main" }, [
                _c("div", { staticClass: "sp-step__line-wrap" }, [
                  _c(
                    "div",
                    {
                      ref: "title",
                      staticClass: "sp-step__title",
                  ...
                  _vm.isSimple
                    ? _c("div", { staticClass: "sp-step__arrow" })
                    : _vm._e(),
                  _c(
                    "div",
                    {
                ...
                !_vm.isSimple
                  ? _c(
                      "div",
                      {
                        staticClass: "sp-step__description",
                        class: ["is-" + _vm.currentStatus]
                      },
                      [
...
// CONCATENATED MODULE: ./packages/steps/src/step.vue?vue&type=template&id=d8cc6738&
...
/* harmony default export */ var stepvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    calcProgress: function calcProgress(status) {
      ...
      if (step && !this.isSimple && this.isVertical) {
        style.borderLeftWidth = '1px';
      } else if (step && !this.isSimple && !this.isVertical) {
