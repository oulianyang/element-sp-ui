...
var menu_mixin = __webpack_require__(59);
...
/* harmony default export */ var submenuvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    menuTransitionName: function menuTransitionName() {
      return this.rootMenu.collapse ? 'sp-zoom-in-left' : 'sp-zoom-in-top';
    },
  ...
  render: function render(h) {
    ...
    var popupMenu = h(
      ...
      [h(
        'div',
        {
          ...
          'class': ['sp-menu--' + mode, popperClass],
          on: {
        ...
        [h(
          'ul',
          {
            ...
            'class': ['sp-menu sp-menu--popup', 'sp-menu--popup-' + currentPlacement],
    ...
    var submenuTitleIcon = rootMenu.mode === 'horizontal' && isFirstLevel || rootMenu.mode === 'vertical' && !rootMenu.collapse ? 'sp-icon-down' : 'sp-icon-right';
    ...
    return h(
      ...
      [h(
        ...
        [$slots.title, h('i', { 'class': ['sp-submenu__icon-arrow', submenuTitleIcon] })]
