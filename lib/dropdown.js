...
/* harmony default export */ var dropdownvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    focusing: function focusing(val) {
      var selfDefine = this.$el.querySelector('.sp-dropdown-selfdefine');
      if (selfDefine) {
        // 自定义
        if (val) {
  ...
  methods: {
    triggerElmRender: function triggerElmRender() {
      var _this = this;
      ...
      if (splitButton) {
        triggerElm = h('el-button-group', [h(
          ...
          { ref: 'trigger', attrs: { type: type, size: dropdownSize, disabled: disabled },
            'class': 'sp-dropdown__caret-button' },
          [this.$slots.icon || h('i', { 'class': 'sp-dropdown__icon sp-icon-down' })]
        )]);
      } else {
