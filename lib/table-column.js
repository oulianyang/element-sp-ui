...
var cellStarts = {
  ...
  selection: {
    ...
    realWidth: 48,
    order: '',
    className: 'sp-table-column--selection'
  },
  expand: {
    width: 48,
    minWidth: 48,
...
var cellForced = {
  ...
  expand: {
    ...
    renderCell: function renderCell(h, _ref6) {
      ...
      var classes = ['sp-table__expand-icon'];
      if (isExpanded) {
        classes.push('sp-table__expand-icon--expanded');
      }
      ...
      return h(
        ...
        [h('i', { 'class': 'sp-icon sp-icon-caret-right' })]
      );
    },
    sortable: false,
    resizable: false,
    className: 'sp-table__expand-column'
  }
};
...
function defaultRenderCell(h, _ref7) {
  ...
  return h(
    'span',
    { 'class': 'sp-table__default-column' },
    [value]
  );
}
...
function treeCellPrefix(h, _ref8) {
  ...
  if (treeNode.indent) {
    ele.push(h('span', { 'class': 'sp-table__indent', style: { 'padding-left': treeNode.indent + 'px' } }));
  }
  if (typeof treeNode.expanded === 'boolean' && !treeNode.noLazyChildren) {
    var expandClasses = ['sp-table__expand-icon', treeNode.expanded ? 'sp-table__expand-icon--expanded' : ''];
    var iconClasses = ['sp-icon-caret-right'];
    if (treeNode.loading) {
      iconClasses = ['sp-icon-loading'];
    }
    ele.push(h(
      'div',
      { 'class': expandClasses,
    ...
    ele.push(h('span', { 'class': 'sp-table__placeholder' }));
  }
  return ele;
}
...
/* harmony default export */ var table_column = ({
  ...
  methods: {
    ...
    setColumnHeaderSecondLine: function setColumnHeaderSecondLine(column) {
      var _this2 = this;

      if (this.renderHeadSecondLine) {
        return column;
      } else if (column.type !== 'selection') {
        column.renderHeadSecondLine = function (h, scope) {
          var renderHeadSecondLine = _this2.$scopedSlots.renderHeadSecondLine;
          return renderHeadSecondLine ? renderHeadSecondLine(scope) : '';
        };
      }
      return column;
    },
    ...
    setColumnRenders: function setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        ...
        column.renderHeader = function (h, scope) {
          var renderHeader = _this3.$scopedSlots.header;
      ...
      if (column.type === 'expand') {
        ...
        this.owner.renderExpanded = function (h, data) {
          return _this3.$scopedSlots.default ? _this3.$scopedSlots.default(data) : _this3.$slots.default;
        };
      } else {
        ...
        column.renderCell = function (h, data) {
          var children = null;
          if (_this3.$scopedSlots.default) {
            children = _this3.$scopedSlots.default(data);
          } else {
    ...
    registerComplexWatchers: function registerComplexWatchers() {
      ...
      Object.keys(allAliases).forEach(function (key) {
        ...
        _this5.$watch(key, function (newVal) {
          _this5.columnConfig[columnKey] = newVal;
          var updateColumns = columnKey === 'fixed';
          _this5.owner.store.scheduleLayout(updateColumns);
        });
      });
    }
  },
  ...
  created: function created() {
    ...
    var basicProps = ['columnKey', 'label', 'className', 'labelClassName', 'type', 'renderHeader', 'formatter', 'fixed', 'resizable', 'explain', 'renderHeadSecondLine'];
    ...
    var chains = Object(util["a" /* compose */])(this.setColumnRenders, this.setColumnWidth, this.setColumnForcedProps, this.setColumnHeaderSecondLine);
