...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/image/src/main.vue?vue&type=template&id=92cb5d76&
var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _vm.loading
        ? _vm._t("placeholder", [
            _c("div", { staticClass: "sp-image__placeholder" })
          ])
        : _vm.error
        ? _vm._t("error", [
            _c("div", { staticClass: "sp-image__error" }, [
        ...
        ? _c(
            ...
            _vm._g(
              _vm._b(
                {
                  staticClass: "sp-image__inner",
                  class: {
                    "sp-image__inner--center": _vm.alignCenter,
                    "sp-image__preview": _vm.preview
                  },
...
// CONCATENATED MODULE: ./packages/image/src/main.vue?vue&type=template&id=92cb5d76&

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/image/src/image-viewer.vue?vue&type=template&id=4c860262&
var image_viewervue_type_template_id_4c860262_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("transition", { attrs: { name: "viewer-fade" } }, [
    _c(
      "div",
      {
        ref: "sp-image-viewer__wrapper",
        staticClass: "sp-image-viewer__wrapper",
        style: { "z-index": _vm.viewerZIndex },
        attrs: { tabindex: "-1" }
      },
      [
        _c("div", {
          staticClass: "sp-image-viewer__mask",
          on: {
        ...
        _c(
          "span",
          {
            staticClass: "sp-image-viewer__btn sp-image-viewer__close",
            on: { click: _vm.hide }
          },
          [_c("i", { staticClass: "sp-icon-close" })]
        ),
        !_vm.isSingle
          ? [
              _c(
                "span",
                {
                  staticClass: "sp-image-viewer__btn sp-image-viewer__prev",
                  class: { "is-disabled": !_vm.infinite && _vm.isFirst },
                  on: { click: _vm.prev }
                },
                [_c("i", { staticClass: "sp-icon-left" })]
              ),
              _c(
                "span",
                {
                  staticClass: "sp-image-viewer__btn sp-image-viewer__next",
                  class: { "is-disabled": !_vm.infinite && _vm.isLast },
                  on: { click: _vm.next }
                },
                [_c("i", { staticClass: "sp-icon-right" })]
              )
            ]
          : _vm._e(),
        _c(
          "div",
          { staticClass: "sp-image-viewer__btn sp-image-viewer__actions" },
          [
            _c("div", { staticClass: "sp-image-viewer__actions__inner" }, [
              _c("i", {
                staticClass: "sp-icon-zoomout",
                on: {
                  click: function($event) {
              ...
              _c("i", { staticClass: "sp-image-viewer__actions__divider" }),
              _c("i", { class: _vm.mode.icon, on: { click: _vm.toggleMode } }),
              _c("i", { staticClass: "sp-image-viewer__actions__divider" }),
              _c("i", {
                staticClass: "sp-icon-rotate-left",
                on: {
                  click: function($event) {
              ...
              _c("i", {
                staticClass: "sp-icon-rotate-right",
                on: {
                  click: function($event) {
        ...
        _c(
          "div",
          { staticClass: "sp-image-viewer__canvas" },
          _vm._l(_vm.urlList, function(url, i) {
            return i === _vm.index
              ? _c("img", {
                  ...
                  ref: "img",
                  refInFor: true,
                  staticClass: "sp-image-viewer__img",
                  style: _vm.imgStyle,
...
var image_viewervue_type_template_id_4c860262_staticRenderFns = []
image_viewervue_type_template_id_4c860262_render._withStripped = true


// CONCATENATED MODULE: ./packages/image/src/image-viewer.vue?vue&type=template&id=4c860262&
...
/* harmony default export */ var image_viewervue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.$refs['sp-image-viewer__wrapper'].focus();
  },
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  image_viewervue_type_template_id_4c860262_render,
  image_viewervue_type_template_id_4c860262_staticRenderFns,
  false,
  null,
  null,
  null
...
var throttle_ = __webpack_require__(45);
