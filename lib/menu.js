...
MenuItem.prototype.init = function () {
  ...
  var menuChild = this.domNode.querySelector('.sp-menu');
  if (menuChild) {
        ...
        var data = {
          ...
          on: {
            ...
            enter: function enter(el) {
              Object(dom_["addClass"])(el, 'sp-opacity-transition');
              el.style.opacity = 1;
            },
            afterEnter: function afterEnter(el) {
              Object(dom_["removeClass"])(el, 'sp-opacity-transition');
              el.style.opacity = '';
            },
            beforeLeave: function beforeLeave(el) {
              if (!el.dataset) el.dataset = {};

              if (Object(dom_["hasClass"])(el, 'sp-menu--collapse')) {
                Object(dom_["removeClass"])(el, 'sp-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                Object(dom_["addClass"])(el, 'sp-menu--collapse');
              } else {
                Object(dom_["addClass"])(el, 'sp-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
