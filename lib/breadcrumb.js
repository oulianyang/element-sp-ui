...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/breadcrumb/src/breadcrumb.vue?vue&type=template&id=83b4bda6&
var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    {
      staticClass: "sp-breadcrumb",
      attrs: { "aria-label": "Breadcrumb", role: "navigation" }
    },
    [
      _vm.prefixText || "prefix" in _vm.$slots
        ? _c(
            "span",
            { staticClass: "sp-breadcrumb__prefix" },
            [_vm._t("prefix", [_vm._v(_vm._s(_vm.prefixText))])],
            2
          )
        : _vm._e(),
      _c(
        "Tooltip",
        {
          staticClass: "sp-breadcrumb__content",
          attrs: {
...
// CONCATENATED MODULE: ./packages/breadcrumb/src/breadcrumb.vue?vue&type=template&id=83b4bda6&
...
/* harmony default export */ var breadcrumbvue_type_script_lang_js_ = ({
  ...
  props: {
    prefixText: {
      type: String,
      default: locale["a" /* default */].methods.t('el.breadcrumb.prefix')
    },
    separator: {
      type: String,
      default: '/'
    ...
    tooltipContent: {
      ...
      get: function get() {
        return this.$slots.default.map(function (slot) {
          return slot.elm && slot.elm.innerText;
        }).filter(function (t) {
          return t;
        }).join(' ' + this.separator + ' ');
      }
  ...
  mounted: function mounted() {
    var items = this.$el.querySelectorAll('.sp-breadcrumb__item');
    if (items.length) {
