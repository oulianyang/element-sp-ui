...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/tabs/src/tab-bar.vue?vue&type=template&id=782a2448&
var tab_barvue_type_template_id_782a2448_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", {
    staticClass: "sp-tabs__active-bar",
    class: "is-" + _vm.rootTabs.tabPosition,
    style: _vm.barStyle
  })
}
var staticRenderFns = []
tab_barvue_type_template_id_782a2448_render._withStripped = true


// CONCATENATED MODULE: ./packages/tabs/src/tab-bar.vue?vue&type=template&id=782a2448&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  tab_barvue_type_template_id_782a2448_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var tab_navvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      'span',
      { 'class': ['sp-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled'], on: {
          'click': scrollPrev
        }
      },
      [h('i', { 'class': 'sp-icon-left' })]
    ), h(
      'span',
      { 'class': ['sp-tabs__nav-next', scrollable.next ? '' : 'is-disabled'], on: {
          'click': scrollNext
        }
      },
      [h('i', { 'class': 'sp-icon-right' })]
    )] : null;
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      var btnClose = closable ? h('span', { 'class': 'sp-icon-close', on: {
      ...
      var dot = pane.dot ? h('sup', { 'class': 'sp-tabs-nav--dot' }) : null;
      ...
      return h(
        ...
        [tabLabelContent, dot, btnClose]
      );
    });
    return h(
      'div',
      { 'class': ['sp-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', 'is-' + this.rootTabs.tabPosition] },
      [scrollBtn, h(
        'div',
        { 'class': ['sp-tabs__nav-scroll'], ref: 'navScroll' },
        [h(
          'div',
          {
            'class': ['sp-tabs__nav', 'is-' + this.rootTabs.tabPosition, stretch && ['top', 'bottom'].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : ''],
            ref: 'nav',
            style: navStyle,
            attrs: { role: 'tablist'
            },
...
/* harmony default export */ var tabsvue_type_script_lang_js_ = ({
  ...
  props: {
    type: String, // 'card' | 'border-card' | 'button-card'
    activeName: String,
    closable: Boolean,
    addable: Boolean,
    value: {},
  ...
  render: function render(h) {
    ...
    //   ? (
    //     <span
    //       class="sp-tabs__new-tab"
    //       on-click={ handleTabAdd }
    //       tabindex="0"
    //       on-keydown={ (ev) => { if (ev.keyCode === 13) { handleTabAdd(); }} }
    //     >
    //       <i class="sp-icon-plusoutline"></i>
    //     </span>
    //   )
    //   : null;

    var newButton = editable || addable ? h(button_default.a, {
      'class': 'sp-tabs__new-tab',
      attrs: { icon: 'sp-icon-plusoutline'
      },
      on: {
        'click': handleTabAdd,
        'keydown': function keydown(ev) {
    ...
    var header = h(
      'div',
      { 'class': ['sp-tabs__header', 'is-' + tabPosition] },
      [newButton, h('tab-nav', navData)]
    );
    var panels = h(
      'div',
      { 'class': 'sp-tabs__content' },
      [this.$slots.default]
    );
    ...
    return h(
      ...
      { 'class': (_ref2 = {
          'sp-tabs': true,
          'sp-tabs--card': type === 'card'
        }, _ref2['sp-tabs--' + tabPosition] = true, _ref2['sp-tabs--border-card'] = type === 'border-card', _ref2['sp-tabs--button-card'] = type === 'button-card', _ref2) },
