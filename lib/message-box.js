...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/message-box/src/main.vue?vue&type=template&id=00fe5207&
var render = function() {
  var _vm = this
  ...
  return _c("transition", { attrs: { name: "msgbox-fade" } }, [
    _c(
      "div",
      {
        ...
        staticClass: "sp-message-box__wrapper",
        attrs: {
          tabindex: "-1",
          role: "dialog",
          "aria-modal": "true",
      ...
      [
        _c(
          "div",
          {
            staticClass: "sp-message-box",
            class: [_vm.customClass, _vm.center && "sp-message-box--center"]
          },
          [
            _vm.title !== null
              ? _c("div", { staticClass: "sp-message-box__header" }, [
                  _c("div", { staticClass: "sp-message-box__title" }, [
                    _vm.icon && _vm.center
                      ? _c("div", {
                          class: ["sp-message-box__status", _vm.icon]
                        })
                      : _vm._e(),
                  ...
                  _vm.showClose
                    ? _c(
                        "button",
                        {
                          staticClass: "sp-message-box__headerbtn",
                        ...
                        [
                          _c("i", {
                            staticClass: "sp-message-box__close sp-icon-close"
                          })
                        ]
                      )
                    : _vm._e()
              ...
              : _vm._e(),
            _c("div", { staticClass: "sp-message-box__content" }, [
              _c("div", { staticClass: "sp-message-box__container" }, [
                _vm.icon && !_vm.center && _vm.message !== ""
                  ? _c("div", { class: ["sp-message-box__status", _vm.icon] })
                  : _vm._e(),
                _vm.message !== ""
                  ? _c(
                      "div",
                      { staticClass: "sp-message-box__message" },
                      [
                        _vm._t("default", [
                          !_vm.dangerouslyUseHTMLString
                            ? _c(
                                "p",
                                {
                                  staticClass: "sp-message-box__message-title"
                                },
                          ...
                          _vm.description
                            ? _c(
                                "p",
                                { staticClass: "sp-message-box__message-desc" },
              ...
              _c(
                "div",
                {
                  ...
                  staticClass: "sp-message-box__input"
                },
                [
                  _c("el-input", {
                    ref: "input",
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "sp-message-box__errormsg",
                      style: {
            ...
            _c(
              "div",
              { staticClass: "sp-message-box__btns" },
              [
...
// CONCATENATED MODULE: ./packages/message-box/src/main.vue?vue&type=template&id=00fe5207&
...
// EXTERNAL MODULE: external "@fe/element-sp-ui/lib/utils/aria-dialog"
var aria_dialog_ = __webpack_require__(75);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    icon: function icon() {
      ...
      return iconClass || (type && typeMap[type] ? 'sp-icon-' + typeMap[type] : '');
    },
    confirmButtonClasses: function confirmButtonClasses() {
      if (this.type === 'error') {
        return 'sp-button--danger ' + this.confirmButtonClass;
      } else {
        return 'sp-button--primary ' + this.confirmButtonClass;
      }
    },
  ...
  methods: {
    ...
    getFirstFocus: function getFirstFocus() {
      var btn = this.$el.querySelector('.sp-message-box__btns .sp-button');
      var title = this.$el.querySelector('.sp-message-box__btns .sp-message-box__title');
      return btn || title;
    },
...
// EXTERNAL MODULE: external "@fe/element-sp-ui/lib/utils/vdom"
var vdom_ = __webpack_require__(41);
...
module.exports = require("@fe/element-sp-ui/lib/utils/vdom");
...
module.exports = require("@fe/element-sp-ui/lib/utils/aria-dialog");
