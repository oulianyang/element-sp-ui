...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/cascader/src/cascader.vue?vue&type=template&id=72abe104&
var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    {
      ...
      class: [
        "sp-cascader",
        _vm.realSize && "sp-cascader--" + _vm.realSize,
        ...
        [
          _c("template", { slot: "suffix" }, [
            _vm.clearBtnVisible
              ? _c("i", {
                  key: "clear",
                  staticClass: "sp-input__icon sp-icon-close-circle",
                  on: {
            ...
            [
              ...
              _vm.filterable && !_vm.isDisabled
                ? _c("input", {
                    ...
                    staticClass: "sp-cascader__search-input",
                    attrs: {
                      type: "text",
        ...
        [
          _c(
            "div",
            {
              ...
              ref: "popper",
              class: ["sp-popper", "sp-cascader__dropdown", _vm.popperClass]
            },
            [
              ...
              _vm.filterable
                ? _c(
                    "el-scrollbar",
                    {
                      ...
                      ref: "suggestionPanel",
                      staticClass: "sp-cascader__suggestion-panel",
                      attrs: {
                        tag: "ul",
                    ...
                    [
                      _vm.suggestions.length
                        ? _vm._l(_vm.suggestions, function(item, index) {
                            return _c(
                              ...
                              [
                                ...
                                item.checked
                                  ? _c("i", { staticClass: "sp-icon-check" })
                                  : _vm._e()
                              ]
                            )
                          })
                        : _vm._t("empty", [
                            _c(
                              "li",
                              { staticClass: "sp-cascader__empty-text" },
                              [
                                _vm._v(
                                  "\n            " +
...
// CONCATENATED MODULE: ./packages/cascader/src/cascader.vue?vue&type=template&id=72abe104&
...
// EXTERNAL MODULE: external "@fe/element-sp-ui/lib/cascader-panel"
var cascader_panel_ = __webpack_require__(82);
...
/* harmony default export */ var cascadervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    focusFirstNode: function focusFirstNode() {
      ...
      this.$nextTick(function () {
        ...
        if (filtering && suggestionPanel) {
          ...
          var firstMenu = popper.querySelector('.sp-cascader-menu');
    ...
    computePresentTags: function computePresentTags() {
      ...
      if (checkedNodes.length) {
        ...
        checkedNodes.forEach(function (item, index) {
          if (index < _this5.maxTagCount) {
            tags.push(genTag(item));
          } else {
            rest.push(item);
          }
        });
    ...
    updateStyle: function updateStyle() {
      ...
      var inputInner = $el.querySelector('.sp-input__inner');

      if (!inputInner) return;

      var tags = $el.querySelector('.sp-cascader__tags');
      var suggestionPanelEl = null;

      if (suggestionPanel && (suggestionPanelEl = suggestionPanel.$el)) {
        var suggestionList = suggestionPanelEl.querySelector('.sp-cascader__suggestion-list');
...
module.exports = require("@fe/element-sp-ui/lib/cascader-panel");
