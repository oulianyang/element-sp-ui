import fecha from '@fe/element-sp-ui/src/utils/date';
...
export const parseQuarterFormatDate = function(string) {
  const qs = string.match(/q[1-4]/gi);
  if (qs) {
    for (const q of qs) {
      const month = String((q.substring(1) - 1) * 3 + 1).padStart(2, 0);
...
export const transformMinDateMaxDate = function(dateRange) {
...
export const megerRangeDate = function(dateRange1, dateRange2) {
